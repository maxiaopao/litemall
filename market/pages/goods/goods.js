...
Page({
  data: {
    ...
    openAttr: false,
    openShare: false,
    noCollectImage: '/static/images/icon-favorite.png',
    hasCollectImage: '/static/images/icon-favorite-active.png',
    collectImage: '/static/images/icon-favorite.png',
    shareImage: '',
