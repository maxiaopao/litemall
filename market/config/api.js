// 以下是业务服务器API地址
// 本机开发时使用
// var WxApiRoot = 'http://192.168.0.17:8080/wx/';
// 局域网测试使用
var WxApiRoot = 'http://192.168.3.121:8080/wx/';
// var WxApiRoot = 'http://c7rs83.natappfree.cc/wx/';
// 云平台部署时使用
...
module.exports = {
  ...
  AddressDistrict: WxApiRoot + 'address/district',//根据省份名称获取id
  AddressSetDefault: WxApiRoot + 'address/resetDefault',//将地址设置为默认
